...
const getWires = (input: string): Point[][] => input
  .split('\n')
  .map(wire => wire.trim())
  .map(wire => {
...
const findIntersections = (wire1: Point[], wire2: Point[]): Point[] => {
...
const doPart1 = (wire1: Point[], wire2: Point[], intersections: Point[]) => {
...
const doPart2 = (wire1: Point[], wire2: Point[], intersections: Point[]) => {
